...
export default function NotificationPreferences(){
  const[enabled,setEnabled]=useState<Record<string,boolean>>(()=>Object.fromEntries(defaults.map(label=>[label,true])));
  function toggle(label:string){setEnabled(current=>({...current,[label]:!current[label]}))}
