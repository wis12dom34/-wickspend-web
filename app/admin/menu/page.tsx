...
const items = [
  ...
  ["Rental Orders", "Inspect existing rental orders, numbers, cost and expiry", "/admin/rentals"],
  ["Mini Store Rentals", "Inspect Mini Store customer rentals, GotSMS references and rental revenue", "/admin/mini-store-rentals"],
  ...
  ["Marketplace Assistants", "Create, activate, revoke and audit Marketplace-only staff", "/admin/staff"],
